...
class ExperimentConfig:
    ...
    # optional factorial layout for the decomposition figure: a grid of condition
    # keys with row/col labels, {"grid": [[cond, ...], ...], "row_labels": [..],
    # "col_labels": [..]} (any RxC shape). None -> the factorial figure is skipped.
    factorial_grid: dict | None = None
