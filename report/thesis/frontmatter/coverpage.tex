...
% \definecolor{backgroundColor}{HTML}{1B262C}
...
\newcommand*{\makecover}{
    ...
    \begin{tikzpicture}[
        ...
        \node[above right=15mm] at (current page.south west) {%
            \includegraphics[width=0.3\linewidth]{layout/Imperial/Imperial_College_London_Logo_White.png}};
