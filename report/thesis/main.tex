...
\begin{document}
    ...
    \subtitle{Tracing Connectivity to Computation in Connectome-Constrained Recurrent Networks}
    ...
    % \input{mainmatter/chapter-0-figures}
    \input{mainmatter/chapter-1-introduction}              
    \input{mainmatter/chapter-2-related-work}   
    \input{mainmatter/chapter-3-methods} 
    \input{mainmatter/chapter-4-act-I}
    \input{mainmatter/chapter-5-act-II}
    \input{mainmatter/chapter-6-act-III} 
    \input{mainmatter/chapter-7-act-IV}
