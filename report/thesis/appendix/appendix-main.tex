...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{figures/CelegansSpectra.png}
    \caption[C.elegans eigenspectra analysis]{
    \textbf{C.elegans eigenspectra analysis}}
    \label{fig:celegans-spectra}
\end{figure}
