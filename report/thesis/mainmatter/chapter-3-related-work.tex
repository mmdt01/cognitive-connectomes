...
A second finding motivates treating the connectome dynamically rather than descriptively.
...
\begin{figure}[h!]
    ...
    \caption{\textbf{Towards connectome-based connectivity in recurrent neural networks}. (Figure taken from \cite{suarez2024connectome})}
...
\section{The geometry of population activity}
...
ju2020dynamic}. The first question asked of such a shape is how many dimensions it occupies,
