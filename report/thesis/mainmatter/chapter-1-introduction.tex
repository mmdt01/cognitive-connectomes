...
\begin{contributions}[Discoveries and contributions]
    ...
    \item \textbf{Memory and prediction are opposite readouts of one structural
    property.} The property that holds a trajectory smooth enough to be
    continued is the same one that synchronises units and consumes the
    directions a readout would otherwise use. Grading weights from non-negative
    to sign-balanced therefore improves one demand and degrades the other, on
    every substrate tested.
