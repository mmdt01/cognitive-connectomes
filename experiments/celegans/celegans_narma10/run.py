"""Run the C. elegans NARMA-10 experiment: matrix -> stats -> figures.
...
config, this task's config, and the generic ``src/experiment`` runner.
    ...
    python -m experiments.celegans.celegans_narma10.run            # full run
...
from experiments.celegans.celegans_narma10 import task_config
